...
const projects = [
  {
    title: 'Dự án Lotte Mart',
    image: '[Ảnh 1]',
    category: 'Bảo vệ Mục tiêu cố định',
  },
  {
    title: 'Hệ thống Camera KCN',
    image: '[Ảnh 2]',
  ...
  {
    title: 'Lắp đặt Báo trộm gia đình',
    image: '[Ảnh 4]',
    ...
    <section className="projects-section">
      <div className="container">
        ...
        <p className="section-subtitle">
          Minh chứng cho chất lượng và uy tín của dịch vụ Anninh City.
        </p>
