    ...
    <section className="about-detail-section">
      <div className="container about-grid">
        ...
        <div className="about-content-col">
          ...
          <p>
            Với hơn 10 năm kinh nghiệm trong ngành, chúng tôi không chỉ cung cấp
            dịch vụ bảo vệ mà còn là đối tác chiến lược, mang đến sự an toàn bền
            vững và sự yên tâm tuyệt đối cho khách hàng.
          </p>
